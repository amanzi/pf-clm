...
subroutine clm1d_balchk (clm, nstep) 
  ...
  !=========================================================================
  ! $Id: clm1d_balchk.F90,v 1.1.1.1 2006/02/14 23:05:52 kollet Exp $
  !=========================================================================
  ...
  !     clm%eflx_impsoil
  if (abs(clm%errseb) > 10.) call clm_abort
  !endif
