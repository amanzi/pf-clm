...
!  neighboring element.  The subroutine clm1d_combo.f90 then executes the 
...
!=========================================================================
! $Id: clm1d_combin.F90,v 1.1.1.1 2006/02/14 23:05:52 kollet Exp $
!=========================================================================
...
! Node l and j are combined and stored as node j.
              ...
              call clm1d_combo ( clm%dz(j), clm%h2osoi_liq(j), clm%h2osoi_ice(j), clm%t_soisno(j),&
