...
subroutine clm1d_combo (dz,     wliq,     wice,     t,            &
                      dz2,    wliq2,    wice2,    t2            ) 
...
!=========================================================================
! $Id: clm1d_combo.F90,v 1.1.1.1 2006/02/14 23:05:52 kollet Exp $
!=========================================================================

  use clm_precision
  use clm1d_varcon,  only : cpice, cpliq, tfrz, hfus         
  implicit none
