...
subroutine clm1d_compact(clm)
  ...
  !=========================================================================
  ! $Id: clm1d_compact.F90,v 1.1.1.1 2006/02/14 23:05:52 kollet Exp $
  !=========================================================================

  use clm_precision
  use clm1d_type_module
  use clm1d_varcon, only : denice, denh2o, tfrz
  implicit none
