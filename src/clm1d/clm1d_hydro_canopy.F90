...
subroutine clm1d_hydro_canopy (clm)
  ...
  ! temperature in the subroutine clm1d_leaftem.f90 not in this subroutine.
  !
  ! REVISION HISTORY:
  ...
  use clm1d_varcon, only : tfrz, istice, istwet, istsoil
  implicit none
  ...
  !        (NOTE: qflx_qirr is set to 0. UNLESS cycle,time,veg-type match up...see clm1d_hydro_irrig)
...
end subroutine clm1d_hydro_canopy
