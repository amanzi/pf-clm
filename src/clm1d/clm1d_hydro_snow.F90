...
subroutine clm1d_hydro_snow(clm)
...
!=========================================================================
! $Id: clm1d_hydro_snow.F90,v 1.1.1.1 2006/02/14 23:05:52 kollet Exp $
!=========================================================================

  use clm_precision
  use clm1d_type_module
  use clm1d_varcon, only : denh2o, denice
  implicit none
...
end subroutine clm1d_hydro_snow
