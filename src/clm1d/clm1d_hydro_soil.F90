...
subroutine clm1d_hydro_soil (clm) 
  ...
  !  processes over soil
  !
  !  (1) Water flow within soil (see clm1d_soilwater.f90)
  !
  !  (2) Runoff 
  ...
  !=========================================================================
  ! $Id: clm1d_hydro_soil.F90,v 1.1.1.1 2006/02/14 23:05:52 kollet Exp $
  !=========================================================================

  use clm_precision
  use clm1d_type_module
  use clm1d_varcon, only : denice, denh2o
  ...
  ! we introduced the Parflow couple, which is called after clm1d_main.
  ! That way clm1d_soilwater becomes obsolete
  !+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++

  ! LEGACY 
  ! call clm1d_soilwater (vol_liq, clm%eff_porosity, clm%qflx_infl, sdamp, &
  !                     dwat   , hk              , dhkdw        , clm)
...
end subroutine clm1d_hydro_soil
