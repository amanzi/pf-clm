...
subroutine clm1d_lake (clm) 
  ...
  !=========================================================================
  ! $Id: clm1d_lake.F90,v 1.1.1.1 2006/02/14 23:05:52 kollet Exp $
  !=========================================================================
  ...
  use clm1d_varpar, only : nlevlak, nlevsno, nlevsoi
  use clm1d_varcon, only : hvap, hfus, rair, cpair, cpliq, tkwat, tkice, &
  ...
  call clm1d_qsadv(clm%t_grnd,clm%forc_pbot,eg,degdT,qsatg,qsatgdT)
  ...
  call clm1d_tridia (nlevlak ,a ,b ,c ,r ,clm%t_soisno(1:nlevlak)) 
