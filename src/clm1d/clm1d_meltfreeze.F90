...
subroutine clm1d_meltfreeze (fact,     brr,       hs,     dhsdT,  &   
                           tssbef,   xmf,       clm) 
...
!=========================================================================
! $Id: clm1d_meltfreeze.F90,v 1.1.1.1 2006/02/14 23:05:52 kollet Exp $
!=========================================================================
...
! Declare Modules and data structures
  ...
  use clm1d_varcon, only : tfrz, hfus
...
end subroutine clm1d_meltfreeze
