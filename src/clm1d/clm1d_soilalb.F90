...
subroutine clm1d_soilalb (clm, coszen, nband, albsnd, albsni)
...
! 
!-----------------------------------------------------------------------
! $Id: clm1d_soilalb.F90,v 1.1.1.1 2006/02/14 23:05:52 kollet Exp $
!-----------------------------------------------------------------------

  use clm_precision
  use clm1d_type_module
  use clm1d_varpar, only : numrad
  use clm1d_varcon, only : albsat, albdry, alblak, albice, tfrz, istice, istsoil
  implicit none
