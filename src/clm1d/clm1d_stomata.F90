...
subroutine clm1d_stomata(mpe,       apar,     ei,        ea,      &
                       tgcm,      o2,       co2,                &
                       btran,     rb,       rs,        psn,     &
...
!=========================================================================
! $Id: clm1d_stomata.F90,v 1.1.1.1 2006/02/14 23:05:52 kollet Exp $
!=========================================================================

  use clm_precision
  use clm1d_type_module
  use clm1d_varcon, only : tfrz
  implicit none
