...
!=========================================================================
! $Id: clm1d_subdiv.F90,v 1.1.1.1 2006/02/14 23:05:52 kollet Exp $
!=========================================================================
...
!       write(6,*)'Subdivided Top Node into two layer (1/2)'
  ...
  if (msno > 1) then
     if (dzsno(1) > 0.02) then
        ...
        call clm1d_combo(dzsno(2),swliq(2),swice(2),tsno(2), &
...
! Subdivided a new layer
  ...
  if (msno > 2) then
     if (dzsno(2) > 0.05) then
        ...
        call clm1d_combo(dzsno(3),swliq(3),swice(3),tsno(3), &
...
! Subdivided a new layer
  ...
  if (msno > 3) then
     if (dzsno(3) > 0.11) then
        ...
        call clm1d_combo(dzsno(4),swliq(4),swice(4),tsno(4), &
...
! Subdivided a new layer
  ...
  if (msno > 4) then
     if (dzsno(4) > 0.23) then 
        ...
        call clm1d_combo(dzsno(5),swliq(5),swice(5),tsno(5), &
