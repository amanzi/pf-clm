...
subroutine clm1d_thermalk (tk, cv, clm)
...
!=========================================================================
! $Id: clm1d_thermalk.F90,v 1.1.1.1 2006/02/14 23:05:52 kollet Exp $
!=========================================================================

  use clm_precision
  use clm1d_type_module
  use clm1d_varcon, only : denh2o, denice, tfrz, tkwat, tkice, tkair, &
