...
!=========================================================================
! $Id: clm1d_type_module.F90,v 1.1.1.1 2006/02/14 23:05:52 kollet Exp $
!=========================================================================
  ...
  public :: clm1d_create, clm1d_create_n, clm1d_destroy
  
  type,public :: clm1d_type
...
! hydrology 
     ...
     real(r8) :: qflx_evap_grnd   ! ground surface evaporation rate (mm h2o/s) (does not include snow sublimation)
...
!hydrology
     ...
     real(r8) :: pf_vol_liq(nlevsoi)    !@ partial volume of liquid water in layer from Parflow over entire domain (Parflow and CLM)
...
!@ Intermediate variables used in ParFlow - CLM couple, pass from parflow to CLM or passed back from CLM to ParFlow
     ...
     integer :: soi_z ! layer id of the reference temperature for vegetation soil temps.  NBE
